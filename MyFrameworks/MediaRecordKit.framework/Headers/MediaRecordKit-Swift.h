...
SWIFT_MODULE_NAMESPACE_PUSH("MediaRecordKit")

SWIFT_CLASS("_TtC14MediaRecordKit13VideoRecorder")
...
@interface VideoRecorder (SWIFT_EXTENSION(MediaRecordKit)) <AVCaptureFileOutputRecordingDelegate>
